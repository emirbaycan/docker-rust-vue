...
pub fn task_router(app_state: Arc<AppState>) -> Router {
    Router::new()
        ...
        .route("/task_agendas/:id", delete(delete_task_agenda_handler).patch(edit_task_agenda_handler))
